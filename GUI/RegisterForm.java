...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (!EmailValidator.validate(email)) {
            JOptionPane.showMessageDialog(this, "( @gmail.com ) Only.");
            return;
        }
        ...
        if (strength == PasswordStrength.INVALID || strength == PasswordStrength.WEAK) {
            JOptionPane.showMessageDialog(this, "Password >= 8 , Have Lower, Upper and Digit. Your password is " + strength);
            return;
        }
        if (userService != null) {
            userService.register(username, confirmpassword, phonenumber, email);
